...
@section('title', 'Tambah User Group - ISUN')
                        ...
                        <div class="permission-module">
                            ...
                            <div class="form-check">
                                <input class="form-check-input permission-cb" type="checkbox"
                                       ...
                                       value="{{ $aksi }}"
                                       id="agenda_{{ $aksi }}"
                                       {{ is_array(old('permissions.agenda')) && in_array($aksi, old('permissions.agenda', [])) ? 'checked' : '' }}>
                        ...
                        <div class="permission-module">
                            ...
                            <div class="form-check">
                                <input class="form-check-input permission-cb" type="checkbox"
                                       ...
                                       {{ is_array(old('permissions.agenda_pimpinan')) && in_array($aksi, old('permissions.agenda_pimpinan', [])) ? 'checked' : '' }}>
                        ...
                        <div class="permission-module">
                            ...
                            <div class="form-check">
                                <input class="form-check-input permission-cb" type="checkbox"
                                       ...
                                       value="{{ $aksi }}"
                                       id="galeri_{{ $aksi }}"
                                       {{ is_array(old('permissions.galeri')) && in_array($aksi, old('permissions.galeri', [])) ? 'checked' : '' }}>
                        ...
                        <div class="permission-module">
                            ...
                            <div class="form-check">
                                <input class="form-check-input permission-cb" type="checkbox"
                                       ...
                                       value="{{ $aksi }}"
                                       id="non_skpd_{{ $aksi }}"
                                       {{ is_array(old('permissions.non_skpd')) && in_array($aksi, old('permissions.non_skpd', [])) ? 'checked' : '' }}>
                        ...
                        <div class="permission-module">
                            ...
                            <div class="form-check">
                                <input class="form-check-input permission-cb" type="checkbox"
                                       ...
                                       value="{{ $aksi }}"
                                       id="pedoman_{{ $aksi }}"
                                       {{ is_array(old('permissions.pedoman')) && in_array($aksi, old('permissions.pedoman', [])) ? 'checked' : '' }}>
                        ...
                        <div class="permission-module">
                            ...
                            <div class="form-check">
                                <input class="form-check-input permission-cb" type="checkbox"
                                       ...
                                       value="{{ $aksi }}"
                                       id="pengaturan_{{ $aksi }}"
                                       {{ is_array(old('permissions.pengaturan')) && in_array($aksi, old('permissions.pengaturan', [])) ? 'checked' : '' }}>
                        ...
                        <div class="permission-module">
                            ...
                            <div class="form-check">
                                <input class="form-check-input permission-cb" type="checkbox"
                                       ...
                                       value="{{ $aksi }}"
                                       id="rilis_{{ $aksi }}"
                                       {{ is_array(old('permissions.rilis')) && in_array($aksi, old('permissions.rilis', [])) ? 'checked' : '' }}>
                        ...
                        <div class="permission-module">
                            ...
                            <div class="form-check">
                                <input class="form-check-input permission-cb" type="checkbox"
                                       ...
                                       value="{{ $aksi }}"
                                       id="skpd_{{ $aksi }}"
                                       {{ is_array(old('permissions.skpd')) && in_array($aksi, old('permissions.skpd', [])) ? 'checked' : '' }}>
                        ...
                        <div class="permission-module">
                            ...
                            <div class="form-check">
                                <input class="form-check-input permission-cb" type="checkbox"
                                       ...
                                       value="{{ $aksi }}"
                                       id="user_group_{{ $aksi }}"
                                       {{ is_array(old('permissions.user_group')) && in_array($aksi, old('permissions.user_group', [])) ? 'checked' : '' }}>
                        ...
                        <div class="permission-module">
                            ...
                            <div class="form-check">
                                <input class="form-check-input permission-cb" type="checkbox"
                                       ...
                                       {{ is_array(old('permissions.user_non_skpd')) && in_array($aksi, old('permissions.user_non_skpd', [])) ? 'checked' : '' }}>
                        ...
                        <div class="permission-module">
                            ...
                            <div class="form-check">
                                <input class="form-check-input permission-cb" type="checkbox"
                                       ...
                                       {{ is_array(old('permissions.user_permission')) && in_array($aksi, old('permissions.user_permission', [])) ? 'checked' : '' }}>
                        ...
                        <div class="permission-module">
                            ...
                            <div class="form-check">
                                <input class="form-check-input permission-cb" type="checkbox"
                                       ...
                                       value="{{ $aksi }}"
                                       id="user_skpd_{{ $aksi }}"
                                       {{ is_array(old('permissions.user_skpd')) && in_array($aksi, old('permissions.user_skpd', [])) ? 'checked' : '' }}>
