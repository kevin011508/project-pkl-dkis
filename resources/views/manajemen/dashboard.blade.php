...
<head>
    ...
    <style>
        ...
        .navbar { background-color: #2741a7; }
        body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f0f2f5; color: #333; }
        .navbar-brand { font-weight: bold; font-size: 1.8rem; letter-spacing: 1px; }
        .sidebar { background-color: var(--primary-color); min-height: calc(100vh - 56px); color: white; padding: 20px 0; box-shadow: var(--box-shadow); }
        .sidebar a { color: #ecf0f1; text-decoration: none; padding: 12px 20px; display: block; transition: all 0.3s; border-left: 4px solid transparent; }
        .sidebar a:hover { background-color: rgba(255,255,255,0.075); border-left: 4px solid var(--secondary-color); padding-left: 25px; }
        .sidebar i { width: 25px; margin-right: 10px; }
        .main-content { padding: 20px; }
        .dashboard-header { margin-bottom: 30px; border-bottom: 1px solid #dee2e6; padding-bottom: 15px; }
        .stat-card { background-color: white; border-radius: var(--border-radius); padding: 25px 20px; margin-bottom: 25px; box-shadow: var(--box-shadow); transition: transform 0.3s, box-shadow 0.3s; border-top: 5px solid var(--secondary-color); text-align: center; }
        .stat-card:hover { transform: translateY(-5px); box-shadow: 0 8px 15px rgba(0,0,0,0.091); }
        ...
        .stat-number { font-size: 2.8rem; font-weight: bold; color: var(--primary-color); margin-bottom: 5px; }
        .stat-label { font-size: 1rem; color: #7f8c8d; font-weight: 500; }
        .stat-icon { font-size: 2.5rem; color: var(--secondary-color); margin-bottom: 15px; }
        .dashboard-title { color: var(--primary-color); font-weight: 600; margin-bottom: 20px; }
        .display-toggle { background-color: var(--accent-color); color: white; border: none; padding: 10px 20px; border-radius: 5px; font-weight: 500; transition: background-color 0.3s; }
        .display-toggle:hover { background-color: #322bc0; }
        .menu-title { padding: 20px 20px 10px; font-size: 15px; font-weight: 700; letter-spacing: 1px; color: #ffffff; text-transform: uppercase; text-align: center; }
        .dropdown-menu-custom { display: none; padding-left: 40px; }
        .sidebar-dropdown.active .dropdown-menu-custom { display: block; }
        ...
        <div class="col-lg-2 col-md-3 sidebar">
            ...
            <li>
                <a href="/manajemen/organisasi">
                    <i class="bi bi-diagram-3"></i> Organisasi
                </a>
            </li>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    displayBtn.addEventListener('click', function() {
        alert('Mode display telah diaktifkan!');
    });
